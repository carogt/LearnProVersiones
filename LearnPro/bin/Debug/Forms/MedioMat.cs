...
namespace LearnPro
{
    public partial class MedioMat : Form
    {
        public MedioMat()
        {
            InitializeComponent();
        ...
        private void MedioMat_Load(object sender, EventArgs e)
        {
            Random r = new Random();
            int resultadosum;
            int resultadores;
            int aleatorio1 = r.Next(10, 100);
            string con1 = aleatorio1.ToString();
            int aleatorio2 = r.Next(10, 100);
            string con3 = aleatorio2.ToString();
            int aleatorio3 = r.Next(1, 3);
            int aleatorio4 = r.Next(20, 200);
            string Error1 = aleatorio4.ToString();
            int aleatorio5 = r.Next(100, 200);
